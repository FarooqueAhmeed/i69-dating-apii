...
SECRET_KEY = "34534645n6rdfghfghfyfnhfghgfhfghgfn64564"#os.getenv("DJ_SECRET_KEY", None)
...
SOCIAL_AUTH_FACEBOOK_KEY = os.getenv(
    "SOCIAL_AUTH_FACEBOOK_KEY", None)  # App Secret
...
SOCIAL_AUTH_TWITTER_CALLBACK_URLS = os.getenv(
    "SOCIAL_AUTH_TWITTER_CALLBACK_URLS", None)
...
if USE_S3:
    # aws settings
    AWS_ACCESS_KEY_ID = 'AKIASSP3E64H5XURTEW2'
    AWS_SECRET_ACCESS_KEY = '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'
    AWS_STORAGE_BUCKET_NAME = 'i69imagesbucket'
    AWS_S3_CUSTOM_DOMAIN = f'{AWS_STORAGE_BUCKET_NAME}.s3.amazonaws.com'
    AWS_S3_OBJECT_PARAMETERS = {'CacheControl': 'max-age=86400'}
    # s3 static settings
    # AWS_LOCATION = 'static'
    # STATIC_URL = f'https://{AWS_S3_CUSTOM_DOMAIN}/{AWS_LOCATION}/'
    # STATICFILES_STORAGE = 'framework.storage_backends.StaticStorage'
...
EMAIL_HOST_PASSWORD = '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'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
